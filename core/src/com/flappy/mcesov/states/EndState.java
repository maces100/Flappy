...
public class EndState extends State {
    ...
    public EndState(com.flappy.mcesov.states.GameStateManager gsm, int score) {
        super(gsm);
        this.score = score;
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        if(allowClicking){
            ...
            if(screenX >= cam.viewportWidth/9 &&
                ...
                gsm.set(new com.flappy.mcesov.states.MenuState(gsm));
            }
            if(screenX >= cam.viewportWidth/9*5 &&
                ...
                gsm.set(new com.flappy.mcesov.states.PlayState(gsm));
            }
        }
