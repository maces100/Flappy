...
public class Tube {
    ...
    public Tube(float x){
        ...
        boundsTop = new Rectangle(posTopTube.x, posTopTube.y, top.getWidth(), top.getHeight());
        boundsBot = new Rectangle(posBotTube.x, posBotTube.y, bot.getWidth(), bot.getHeight());
    }
